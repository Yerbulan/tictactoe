"""This module is responsible for taking the player from screen to screen and killing previous 
processes so they stop working once there's no need for them. 
"""
...
# This module is where calculations happen to determine allowed turns, whose turn it is, and what the AI's turn will be
import game_logic as gl


# The first screen. Automatically closes the last one if the game was restarted. Gives the player options to start the game or to quit
...
# Second screen. Automatically closes the first one. Allows the player to choose difficulty level.
# Check out game_logic.py to see how game difficilties work
...
# Third screen. Automatically closes the second one. Gives the player options to use either x or o
...
# Fourth screen. Automatically closes the third one. Gives the player options to use either x or o
...
# Displays the resul of the game. Only option it gives is to click anywhere to proceed to the next screen
...
# Fifth screen. Automatically closes the fourth one. Gives the player options to restart the game/
